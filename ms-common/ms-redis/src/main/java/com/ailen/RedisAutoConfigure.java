...
public class RedisAutoConfigure {
     ...
     * 在spring.factories被autoconfiguration配置启动后，会生成redisAutoConfigure的bean，
     * 这里的redisRepository也会被作为bean注入到容器中，通过autowrite注入到方法中即可使用redis的相关操作
     * @param redisTemplate the redis template
     * @return the redis repository
     */
    @Bean
    //确保只有一个名称为redisRepository的bean被注册
